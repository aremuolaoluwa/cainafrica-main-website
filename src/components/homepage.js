      ...
      <header>
        <div className="header-image">
            <div className="nav-bar">
                <div className="logo-container"><a href="https://www.cainafrica.org/#/home"><img className="logo" src="./assets/images/CainWhiteLogo.png" alt="Logo" /></a></div>
                <div className="nav-bar-items">
                    <a href="">Home</a>
                    <a href="">About Us</a>
                    <a href="">Projects</a>
                    <span className="drop-down">
                        <span className="drop-btn"><a href="" className="team">Resources</a></span>
                        <span className="drop-down-content">
                            <a href="" className="dropbtn-content">Gallery</a>
                        </span>
                    </span>
                    <span className="drop-down">
                        <span className="drop-btn"><a href="" className="team">Team</a></span>
                        <span className="drop-down-content">
                            <a href="" className="dropbtn-content">Board of Trustees</a>
                            <a href="" className="dropbtn-content">Management Staff</a>
                            <a href="" className="dropbtn-content">Educational Staff</a>
                            <a href="" className="dropbtn-content">Support Staff</a>
                            <a href="" className="dropbtn-content">Volunteer With Us</a>
                        </span>
                    </span>
                    <a href="donate.html">
